...
class plgJAtomSTinkoffInstallerScript
{
	/**
	...
	protected function checkCompatible()
	{
		...
		{
			JFactory::getApplication()->enqueueMessage(JText::sprintf('PLG_JATOMS_TINKOFF_ERROR_COMPATIBLE_JOOMLA',
		...
		{
			$app->enqueueMessage(Text::sprintf('PLG_JATOMS_TINKOFF_ERROR_COMPATIBLE_PHP', $this->minimumPhp),
				'error');
		...
		{
			$app->enqueueMessage(Text::sprintf('PLG_JATOMS_TINKOFF_ERROR_COMPATIBLE_JOOMLA', $this->minimumJoomla),
				'error');
